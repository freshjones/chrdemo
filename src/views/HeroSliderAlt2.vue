    ...
    <div class="max-h-hero min-h-hero">
      <div class="relative ">
        ...
        <div class="absolute z-20 top-0 left-0 w-full flex justify-center items-center h-4/6">
            <div class="w-full h-full flex relative max-w-screen-lg  ">
                <div class="w-4/5 flex-grow flex flex-col justify-center items-center">
                    <hero-content :slide="activeSlide"></hero-content>
                </div>
                <div class="w-1/5 p-10 top-0 right-0">
